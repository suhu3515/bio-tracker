							...
							<div class="card">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" class="form-control" id="ins_name" name="ins_name" placeholder="Instruction Title" required><br>
                                    </div>
                                    <div class="form-group col-md-8">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <textarea class="form-control" rows="4" id="ins_text" name="ins_text" placeholder="Instruction Text" required></textarea>
                                    </div>
                                    <div class="form-group col-md-8">
...
if (isset($_POST['add_ins']))
{
    ...
    $res_ins = $conn->query("insert into instructions(ins_language,ins_name,ins_text,status) values ('$instruction_lang','$instruction_title','$instruction_text','$status')");
    if ($res_ins)
    {
        echo "<script>alert('Added instruction')</script>";
