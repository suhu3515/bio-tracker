                            ...
                            <div class="card">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="d-none d-md-table-cell" style="width:25%">Seller</th>
                                    ...
                                    $product_sel = "select * from marketplace";
                                    ...
                                    while ($product_row = $product_res->fetch_array())
                                    {
                                        ...
                                        $sel_seller = "select seller_name from seller where seller_id='$product_row[6]'";
                                        $res_seller = $conn->query($sel_seller);
                                        while($row_seller = $res_seller->fetch_array())
                                        {
                                            echo "<td>$row_seller[0]</td>";
                                        }
                                        if ($product_row[7] == 0)
                                        {
